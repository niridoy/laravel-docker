                    ...
                    <form class="form-horizontal" action="{{ route('admin.users.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 row  @error('start_date') has-error @enderror ">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control date" type="text" name="start_date" value="{{ old('start_date') }}" placeholder="Enter Start Date">
                                    @error('start_date')
                                    <span class="help-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-6 row  @error('building_no') has-error @enderror ">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" name="building_no" value="{{ old('building_no') }}" placeholder="Enter Building Number">
                                    @error('building_no')
                                    <span class="help-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-6 row  @error('customer_id') has-error @enderror ">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" name="customer_id" value="{{ old('customer_id') }}" placeholder="Enter Customer ID">
                                    @error('customer_id')
                                    <span class="help-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
